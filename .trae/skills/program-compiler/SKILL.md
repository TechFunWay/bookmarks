...
编译完成后，在 `release/{VERSION}/` 目录下生成：

```
release/
└── v2.1.0/
    ├── bookmarks-v2.1.0-linux-amd64/
    │   └── bookmarks
    ├── bookmarks-v2.1.0-linux-arm64/
    │   └── bookmarks
    ├── bookmarks-v2.1.0-macos-amd64/
    │   └── bookmarks
    ├── bookmarks-v2.1.0-macos-arm64/
    │   └── bookmarks
    ├── bookmarks-v2.1.0-windows-amd64/
    │   └── bookmarks.exe
    ├── bookmarks-v2.1.0-windows-arm64/
    │   └── bookmarks.exe
    ├── bookmarks-v2.1.0-linux-amd64.tar.gz
    ├── bookmarks-v2.1.0-linux-arm64.tar.gz
    ├── bookmarks-v2.1.0-macos-amd64.tar.gz
    ├── bookmarks-v2.1.0-macos-arm64.tar.gz
    ├── bookmarks-v2.1.0-windows-amd64.tar.gz
    └── bookmarks-v2.1.0-windows-arm64.tar.gz
```
